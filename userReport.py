...
class reportTool(BaseTool):
    ...
    def getMetric(self, metr: str) -> List[str]:
        prompt = """Take the following dimension into consideration, which stands for the data required
            {st}
            Among the following metric API names, form and return a list of less than 10 metrics that correspond the best with the given dimensions above. They should be a subset of the above provided dimensions, and not point to other data not required.
